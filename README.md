...
# Initial Setup Instructions for OSX #
...
To receive webhooks locally, we need to also run `ngrok` in the terminal (use the same `SITE_DOMAIN` from your `.env` file above):
```
